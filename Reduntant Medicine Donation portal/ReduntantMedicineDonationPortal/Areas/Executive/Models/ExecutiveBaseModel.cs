...
namespace Reduntant_Medicine_Donation_portal.Areas.Executive.Models
{
    public abstract class ExecutiveBaseModel
    {
        ...
        public ExecutiveBaseModel(IHttpContextAccessor httpContextAccessor)
        {
            _httpContextAccessor = httpContextAccessor;
            SetupMenu();
        }

        public ExecutiveBaseModel()
        {
