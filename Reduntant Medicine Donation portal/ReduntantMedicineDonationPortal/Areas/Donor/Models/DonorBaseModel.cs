...
namespace Reduntant_Medicine_Donation_portal.Areas.Donor.Models
{
    public abstract class DonorBaseModel
    {
        ...
        public DonorBaseModel(IHttpContextAccessor httpContextAccessor)
        {
            _httpContextAccessor = httpContextAccessor;
            SetupMenu();
        }

        public DonorBaseModel()
        {
